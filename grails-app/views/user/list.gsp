			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="introduction" title="${message(code: 'user.introduction.label', default: 'Introduction')}" />
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: userInstance, field: "introduction")}</td>
