			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="introduction" title="${message(code: 'area.introduction.label', default: 'Introduction')}" />
					
						<th><g:message code="area.admin.label" default="Admin" /></th>
				...
				<g:each in="${areaInstanceList}" status="i" var="areaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: areaInstance, field: "introduction")}</td>
					
						<td>${fieldValue(bean: areaInstance, field: "admin")}</td>
